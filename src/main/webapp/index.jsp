...
<body>
    <div class="login-container">
        ...
        <a class="register-link" href="register.html"><i class="fas fa-user-plus"></i> New User? Register Now</a>
    </div>

    <div class="popup" id="popup">
        <i class="fas fa-check-circle"></i> Logged in successfully!
    </div>
